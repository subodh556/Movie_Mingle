        ...
        <div className="relative h-full w-full bg-[url('/images/hero.jpg')] bg-no-repeat bg-center bg-fixed bg-cover">
          <div className="bg-black w-full h-full lg:bg-opacity-60">
            ...
            <div className="flex justify-center">
                <div className="bg-black bg-opacity-90 px-8 py-8 self-center mt-2 lg:w-2/5 lg:max-w-md rounded-md w-full">
                ...
                <p className="text-neutral-500 mt-12">
                    {variant === 'login' ? 'New on netflix? ' : 'Already have an account? '}
